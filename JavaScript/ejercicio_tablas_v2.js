...
//Añadir una columna y un boton por cada fila en esa columna de forma automática
//Cada botón debe decir "Eliminar"
function crearTabla() {
  ...
  cadena = cadena + "<th>Acción</th></tr></thead>";
  cadena = cadena + "<tbody>";
  ...
  for (const usuario of usuarios) {
    ...
    cadena = cadena + "<td><button class='btn btn-editar' onclick='eliminarFila()'>Eliminar</button></td>";
    cadena = cadena + "</tr>";
  }
  cadena = cadena + "</tbody>";
  cadena = cadena + "</table>";
